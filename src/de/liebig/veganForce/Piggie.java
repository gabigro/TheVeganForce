...
public class Piggie extends Actor {
	...
	void caught() {
		...
		try {
			File aResource = new File("/C:/Informatik Q-Phase/Q1 Informatik/eclipseWorkspace/schweinImWeltall_littlemisssunshine/src/sounds/1_person_cheering-Jett_Rifkin-1851518140.wav");
